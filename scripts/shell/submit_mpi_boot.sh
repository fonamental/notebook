...
#PBS -l walltime=10:00:00    # Duration in seconds
...
# Commande à exécuter
mpirun -n 128 /home/delcampo/bin/raxmlHPC-MPI-SSE3 -m GTRCAT -c 25 -e 0.1 -b 1714 -p 31415 -d -f d -N 1000 -n strams -s STR1226.trim.phy
