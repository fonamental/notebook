...
#genbank search and retrieval of feature object

	  foreach my $feature_obj ( $seq_obj->get_SeqFeatures ) {	
        my $primary_tag = $feature_obj->primary_tag;
        my $tag= '';
        
#different loop for gene or rRNA product
...
#genbank search for start/end of fasta file
